module.exports = function (e) {
  ...
  var r = t;
  r.version = n(57).version, r.transports = n(58);
  var i = n(11);
  r.hash = i.hash, r.clone = i.clone, r.longestElement = i.longestElement, r.exception = n(36), r.config = n(29), r.addColors = r.config.addColors, r.Container = n(83).Container, r.Logger = n(84).Logger, r.Transport = n(16).Transport, r.loggers = new r.Container;
  var o = new r.Logger({
  ...
  t.setLevels = function (e, n, r, i) {
    ...
    var n = {};
    if (e instanceof Error) return n = {
      message: e.message
    ...
    var n, i = "function" == typeof e.timestamp ? e.timestamp : t.timestamp,
    ...
    if (e.raw) return "object" != typeof c && null != c && (c = {
      meta: c
    }), (n = t.clone(c) || {}).level = e.level, n.message = e.message.stripColors ? e.message.stripColors : e.message, JSON.stringify(n);
    if (e.json || !0 === e.logstash) {
      if ("object" != typeof c && null != c && (c = {
          meta: c
        }), (n = t.clone(c) || {}).level = e.level, n.message = n.message || "", e.label && (n.label = e.label), e.message && (n.message = e.message), s && (n.timestamp = s), !0 === e.logstash) {
        var l = {};
    ...
    if (n = s ? s + " - " : "", a && (n += "all" === e.colorize || "level" === e.colorize || !0 === e.colorize ? u.colorize(e.level) : e.level), n += e.align ? "\t" : "", n += s || a ? ": " : "", n += e.label ? "[" + e.label + "] " : "", n += "all" === e.colorize || "message" === e.colorize ? u.colorize(e.level, e.message) : e.message, null != c)
      if (c && c instanceof Error && c.stack && (c = c.stack), "object" != typeof c) n += " " + c;
      else if (Object.keys(c).length > 0)
      if ("function" == typeof e.prettyPrint) n += " " + e.prettyPrint(c);
      else if (e.prettyPrint) n += " \n" + r.inspect(c, !1, e.depth || null, e.colorize);
    else if (e.humanReadableUnhandledException && 5 === Object.keys(c).length && c.hasOwnProperty("date") && c.hasOwnProperty("process") && c.hasOwnProperty("os") && c.hasOwnProperty("trace") && c.hasOwnProperty("stack")) {
      var f = c.stack;
  ...
  r.supportsColor = n(65), void 0 === r.enabled && (r.enabled = r.supportsColor), r.stripColors = r.strip = function (e) {
  ...
  r.setTheme = function (e) {
    if ("string" == typeof e) try {
      return r.themes[e] = n(66)(e), h(r.themes[e]), r.themes[e]
    } catch (e) {
  ...
  for (var d in r.trap = n(67), r.zalgo = n(68), r.maps = {}, r.maps.america = n(69), r.maps.zebra = n(70), r.maps.rainbow = n(71), r.maps.random = n(72), r.maps) ! function (e) {
    r[e] = function (t) {
      return p(r.maps[e], t)
    }
  }(d);
  ...
  i.addColors = function (e) {
    ...
    return n
  }, i.cli = n(73), i.npm = n(74), i.syslog = n(75), i.addColors(i.cli.colors), i.addColors(i.npm.colors), i.addColors(i.syslog.colors)
}, function (e, t) {
      ...
      var s = 0,
        a = function () {
          var c = !0,
            u = r[s];
          t(e[u], u, (function (e) {
            e ? (n(e), n = function () {}) : (s += 1) >= i ? n(null) : c ? o.nextTick(a) : a()
          })), c = !1
        };
      a()
        ...
        return function (t, n, r) {
          ...
          ! function u() {
            ...
            for (; c < e && a < o;) {
              ...
              var l = i[(a += 1) - 1];
              n(t[l], l, (function (e) {
                e ? (r(e), r = function () {}) : (c -= 1, (s += 1) >= o ? r() : u())
              }))
            }
          }()
        }
        ...
        i = {
          ...
          process: function o() {
            if (!n) {
              ...
              var s = "number" == typeof t ? r.splice(0, t) : r.splice(0, r.length),
                a = h(s, (function (e) {
                  return e.data
                }));
  ...
  function u({
    ...
    const v = u ? "&Remove…" : "&Remove",
      w = h ? "Show &pull request" : "Create &pull request",
      b = new Array,
      _ = {
        type: "separator"
      };
    ...
    b.push({
      ...
      submenu: [{
        ...
        label: "用" + (null != t ? t : "Command Prompt") +"打开",
        id: "open-in-shell",
        accelerator: "Ctrl+`",
        ...
        label: "用" + (null != e ? e : "external editor") +"打开",
  ...
  function f(e) {
    return (t, n) => {
      n ? n.webContents.send("menu-event", {
        name: e
      }) : r.ipcMain.emit("menu-event", {
        name: e
      })
    }
  }! function (e) {
  ...
  var r, i = n(114).SourceMapConsumer,
    o = n(1);
  try {
  ...
  cycle.decycle = function (e) {
    ...
    return function e(r, i) {
      ...
      if (!("object" != typeof r || null === r || r instanceof Boolean || r instanceof Date || r instanceof Number || r instanceof RegExp || r instanceof String)) {
        ...
        if (t.push(r), n.push(i), "[object Array]" === Object.prototype.toString.apply(r))
          for (a = [], o = 0; o < r.length; o += 1) a[o] = e(r[o], i + "[" + o + "]");
        else
          for (s in a = {}, r) Object.prototype.hasOwnProperty.call(r, s) && (a[s] = e(r[s], i + "[" + JSON.stringify(s) + "]"));
        return a
      }
      return r
    }(e, "$")
  ...
  n.keys = function () {
    return []
  }, n.resolve = n, e.exports = n, n.id = 66
}, function (e, t) {
  ...
  e.exports = function (e, t) {
    ...
    return function (e, t) {
      var r, s, a = "";
      for (s in (t = t || {}).up = t.up || !0, t.mid = t.mid || !0, t.down = t.down || !0, t.size = t.size || "maxi", e = e.split(""))
        if (!o(s)) {
          switch (a += e[s], r = {
            up: 0,
            down: 0,
          ...
          var c = ["up", "mid", "down"];
          for (var u in c)
            for (var l = c[u], f = 0; f <= r[l]; f++) t[l] && (a += n[l][i(n[l].length)])
        } return a
    }(e)
  }
}, function (e, t, n) {
  ...
  var r = n(2),
    ...
    p = t.File = function (e) {
      ...
      if (u.call(this, e), e.filename || e.dirname) n("filename or dirname", "stream"), this._basename = this.filename = e.filename ? i.basename(e.filename) : "winston.log", this.dirname = e.dirname || i.dirname(e.filename), this.options = e.options || {
        flags: "a"
  ...
  i.inherits(f, r.EventEmitter), f.prototype.configure = function (e) {
    ...
    if (a.length) {
      var c, u = {},
        f = t && t[0] && t[0].match && null !== t[0].match(l),
        h = f ? t[0].match(l) : [],
  ...
  const r = n(6).fromPromise,
    i = n(100);
  i.outputJson = r(n(106)), i.outputJsonSync = n(107), i.outputJSON = i.outputJson, i.outputJSONSync = i.outputJsonSync, i.writeJSON = i.writeJson, i.writeJSONSync = i.writeJsonSync, i.readJSON = i.readJson, i.readJSONSync = i.readJsonSync, e.exports = i
}, function (e, t, n) {
  "use strict";
  const r = n(101);
  e.exports = {
  ...
  e.exports = function (e, t, n) {
    const o = (n = n || {}).overwrite || n.clobber || !1,
      {
        srcStat: l
      } = c.checkPathsSync(e, t, "move");
    return c.checkParentPathsSync(e, l, t, "move"), a(i.dirname(t)),
      function (e, t, n) {
  ...
  var r = n(2),
    ...
    d = e.exports = function (e) {
      ...
      if (a.call(this, e), e.filename || e.dirname) t("filename or dirname", "stream"), this._basename = this.filename = e.filename ? i.basename(e.filename) : "winston.log", this.dirname = e.dirname || i.dirname(e.filename), this.options = e.options || {
        flags: "a"
      }, this.options.highWaterMark = this.options.highWaterMark || 24;
      else {
        if (!e.stream) throw new Error("Cannot log to file without filename or stream.");
      ...
      this.json = !1 !== e.json, this.colorize = e.colorize || !1, this.maxsize = e.maxsize || null, this.logstash = e.logstash || null, this.maxFiles = e.maxFiles || null, this.label = e.label || null, this.prettyPrint = e.prettyPrint || !1, this.showLevel = void 0 === e.showLevel || e.showLevel, this.timestamp = void 0 === e.timestamp || e.timestamp, this.datePattern = e.datePattern ? e.datePattern : ".yyyy-MM-dd", this.depth = e.depth || null, this.eol = e.eol || u.EOL, this.maxRetries = e.maxRetries || 2, this.prepend = e.prepend || !1, this.createTree = e.createTree || !1, this.localTime = e.localTime || !1, this.zippedArchive = e.zippedArchive || !1, this.maxDays = e.maxDays || 0, this.json && (this.stringify = e.stringify), this._size = 0, this._created = 0, this._buffer = [], this._draining = !1, this._failures = 0, this._archive = !1, this._currentFiles = function () {
        if (!this.maxsize) try {
          return r.readdirSync(this.dirname).filter(function (e) {
            ...
            return {
              name: e,
              time: r.statSync(i.join(this.dirname, e)).mtime.getTime()
            }
  ...
  o.inherits(d, a), l.transports.DailyRotateFile = d, d.prototype.name = "dailyRotateFile", d.prototype.log = function (e, t, n, r) {
    ...
    var n = this,
      ...
      s = [],
      a = 0;
    e = n.normalizeQuery(e), 0 === o.length && t && t(null, s),
      function c(u) {
        if (u) {
          var l = i.join(n.dirname, u),
            f = "",
            h = r.createReadStream(l, {
              encoding: "utf8"
            });
    ...
    if (e) {
      if (this.maxFiles && this._created >= this.maxFiles - 1)
        if (0 === (t = this._created - (this.maxFiles - 1))) try {
  ...
  t.SourceMapGenerator = n(42).SourceMapGenerator, t.SourceMapConsumer = n(117).SourceMapConsumer, t.SourceNode = n(120).SourceNode
}, function (e, t) {
  ...
  c.fromSourceMap = function (e) {
    ...
    for (var n, i, o, c, u, f = 1, h = 0, p = 0, d = 0, m = 0, y = 0, g = e.length, v = 0, w = {}, b = {}, _ = [], S = []; v < g;)
    ...
    for (var n = 0; n < this._sections.length; n++)
      for (var i = this._sections[n], o = i.consumer._generatedMappings, s = 0; s < o.length; s++) {
        var c = o[s],
          u = i.consumer._sources.at(c.source);
  ...
  a.debuglog ? l = a.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (l = function () {
    ...
    l(s), n(21).equal(s.length, 0)
  })), e.exports = f(n(45)), process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && (e.exports = f(r)), e.exports.close = r.close = (c = r.close, function (e, t) {
    return c.call(r, e, (function (e) {
      e || p(), "function" == typeof t && t.apply(this, arguments)
    }))
  }), e.exports.closeSync = r.closeSync = (u = r.closeSync, function (e) {
  ...
  Object.defineProperty(t, "__esModule", {
    value: !0
  }), t.isRunningUnderARM64Translation = void 0;
  const r = n(132);
      ...
      Object(s.ensureDir)(n).then(() => {
        try {
          const t = function (e) {
            ...
            t.on("error", () => {});
            const n = new i.transports.Console({
              level: "error"
            });
            return i.configure({
              transports: [n, t]
  ...
  function N(e) {
    ...
    switch (c) {
      ...
      case "submenu":
        return {
          id: t, type: "submenuItem", label: i, enabled: n, visible: r, menu: A(e.submenu, t), accessKey: a
        };
      case "checkbox":
        return {
  ...
  class D {
    ...
    showCertificateTrustDialog(e, t) {
      O.dialog.showCertificateTrustDialog(this.window, {
        certificate: e,
        message: t
      }, () => {})
    }
  ...
  function $() {
    for (const t of Object(q.enumerateValues)(q.HKEY.HKEY_CURRENT_USER, "Environment"))
      if ("Path" === t.name && ((e = t).type === q.RegistryValueType.REG_SZ || e.type === q.RegistryValueType.REG_EXPAND_SZ)) return t.data.split(";").filter(e => e.length > 0);
    var e;
  ...
  async function Q() {
    const e = Z();
    await Object(s.ensureDir)(e), await
    function (e) {
      const t = `@echo off\n"%~dp0\\${ee(e,"resources/app/static/github.bat")}" %*`,
  ...
  function le(e, t) {
    return function e(t, n, r = []) {
      ...
      for (const [o, s] of t.entries())
        if (ce(s.role, "editmenu"))
          for (const e of ue()) i.append(e);
        else {
          const t = [...r, o];
  ...
  function ge() {
    return {
      uptime: ((F() - he) / 1e3).toFixed(3),
      time: (new Date).toString()
    }
  }
  const ve = new Set(["x-github-client"]);
  ve.add("x-github-desktop-auth"), ve.add("github-windows"), O.app.on("window-all-closed", () => {}), process.on("uncaughtException", e => {
    oe(e = b(e), ge()), ye(e)
  });
  let we = !1;
  ...
  process, O.app.on("will-finish-launching", () => {
    ...
    _e || we || (de = F() - he, ve.forEach(e => function (e) {
    ...
    }), O.ipcMain.on("execute-menu-item", (e, {
      id: t
    }) => {
      ...
      const r = le(t, e => n(e)),
        i = O.BrowserWindow.fromWebContents(e.sender) || void 0;
      r.popup({
        window: i,
        callback: () => n(null)
      })
      ...
      fe && fe.sendAppMenu()
    }), O.ipcMain.on("show-certificate-trust-dialog", (e, {
      certificate: t,
      message: n
    }) => {
      Ee(e => {
      ...
      ye(t)
    }), O.ipcMain.on("send-error-report", (e, {
      error: t,
      extra: n,
      nonFatal: r
    }) => {
      oe(t, Object.assign(Object.assign({}, ge()), n), r)
    }), O.ipcMain.on("open-external", async (e, {
      path: t
    }) => {
    ...
    }), O.ipcMain.on("show-item-in-folder", (e, {
      path: t
    }) => {
      l.stat(t, e => {
        e ? log.error(`Unable to find file at '${t}'`, e) : O.shell.showItemInFolder(t)
      })
    }), O.ipcMain.on("show-folder-contents", async (e, {
      path: t
    }) => {
